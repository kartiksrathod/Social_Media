        ...
        <div className="space-y-3">
          {notifications.map((notif) => (
            <Link
              key={notif.id}
              to={notif.link || '#'}
              className="flex items-start gap-4 p-4 rounded-xl bg-surface-700 hover:bg-surface-600 transition-all duration-200 border border-border hover:border-primary/30 cursor-pointer group card-premium block"
            >
              <div className="mt-1">
